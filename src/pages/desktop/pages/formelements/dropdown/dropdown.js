...
function open() {
    ...
    if (this.config.open === false) {
        ...
        this.$element.addClass(this.$element.parent().attr('class').split(' ')[0] + '__dropdown_expanded');
...
function close() {
        ...
        if (this.config.open === true) {
            ...
            this.$element.removeClass(this.$element.parent().attr('class').split(' ')[0] + '__dropdown_expanded');
